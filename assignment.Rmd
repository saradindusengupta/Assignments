...
```{r}
ggplot(df_1, aes(x = total_impressions, y = publisher_revenue),color = "blue") + geom_point() + stat_smooth()+labs(title = paste("Total Impressions v Revenue ",sep = ''),x = "No of Impressions", y = "Earned Revenue")
df_1_1 <- df_1[,c(1,11,12,13,14,15,16,17)]
corMatrix <- rcorr(as.matrix(df_1_1[,-c(1)]))
ggcorrplot(corMatrix$r, method = "circle")
